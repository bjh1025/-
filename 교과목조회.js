var lecturelist = [
  ...
  {major1:"교양학부",major2:"교양학부", grade:"전학년", lecname:"채플", lecno: 11424, div: "채플", credit: 0, stuno: 700, time1: "화", time2: "7", statime: "7", fintime:"8", profes:"교목실", lecdiv:"실기", theory:0, practice:1},
  ...
  {major1:"교양학부",major2:"교양학부", grade:"전학년", lecname:"ACE202", lecno: 14900, div: "교양필수", credit: 2, stuno: 15, time1: "월", time2: "2,3", statime: "2", fintime:"3", profes:"교양교수4", lecdiv:"이론/실기", theory:1, practice:1},
    ...
    function displaySelected() {
      ...
      var selectTable = document.getElementById("selectTable2");
      ...
      for (var i = 0; i < filteredData.length; i++) {
        ...
        applyButton.addEventListener("click", function() {
          ...
          if (existingLecture) {
            ...
            // Create "관심과목 삭제" button
            var removeButton = document.createElement("button");
            removeButton.innerHTML = "관심과목 삭제";
